              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-purple-600 bg-opacity-90 text-white shadow-lg border border-purple-400 font-bold' 
                      : 'text-purple-100 hover:bg-purple-700 hover:bg-opacity-70 hover:text-white font-medium hover:shadow-md hover:font-semibold'
                    }
                  `}
                  onClick={() => setSidebarOpen(false)}
                >
                  <Icon className={`mr-3 h-5 w-5 ${isActive ? 'text-white' : 'hover:text-white'}`} />
                  <span className={`${isActive ? 'text-white font-bold' : 'hover:text-white hover:font-semibold'}`}>
                    {item.name}
                  </span>
                </Link>
              );
